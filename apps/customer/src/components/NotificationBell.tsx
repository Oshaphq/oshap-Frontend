  ...
  return (
    <>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute top-0 right-0 inline-flex items-center justify-center min-w-4 h-4 px-1 text-[10px] font-bold text-on-primary bg-primary rounded-full transform translate-x-1 -translate-y-1 shadow-sm">
