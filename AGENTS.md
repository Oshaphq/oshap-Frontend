...
- Subscription plans differ by **capacity, not capability** — every tier gets the whole product, and Lite is capped at 3 active staff accounts and 10 tables. Do not gate a feature behind a tier. See [`docs/plans.md`](docs/plans.md).
